...
#conda/pip install lightning-flash[audio]
import flash
import numpy as np
import random
...
k_acc = pd.read_csv('/Users/leomoore/koreanaccents.csv')
all_acc = pd.read_csv('/Users/leomoore/allaccents.csv')
...
print(notraining_all)
print(onlyko_all)
print(multacc_all)
trainer.save_checkpoint("speech_recognition_model.pt")
with open('notraining_all.txt', 'w') as n:
    for line in notraining_all:
        n.write(line+'\n')

with open('onlyko_all.txt', 'w') as o:
    for line in onlyko_all:
        o.write(line+'\n')

with open('multiacc_all.txt', 'w') as m:
    for line in multiacc_all:
        m.write(line+'\n')
